              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    (mainP.items != null && mainP.items!.isNotEmpty) ? Text('${locale.orderedOn!} ${mainP.items![0].orderDate}', style: Theme.of(context).textTheme.titleSmall!.copyWith(fontSize: 10.5)) : const SizedBox.shrink(),
                  ],
                ),
              ),
            ],
